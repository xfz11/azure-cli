...
class ComputeManagementClientCommandsLoader(AzCommandsLoader):
    ...
    def __init__(self, cli_ctx=None):
        ...
        from .generated._client_factory import cf_vm_cl
        vm_custom = CliCommandType(
            operations_tmpl='azure.cli.command_modules.vm.custom#{}',
            client_factory=cf_vm_cl)
        parent = super(ComputeManagementClientCommandsLoader, self)
        parent.__init__(cli_ctx=cli_ctx, custom_command_type=vm_custom)
