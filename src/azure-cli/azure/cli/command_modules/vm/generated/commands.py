...
def load_command_table(self, _):
    ...
    from ..generated._client_factory import cf_gallery_image
    vm_gallery_image = CliCommandType(
        operations_tmpl='azure.mgmt.compute.operations._gallery_images_operations#GalleryImagesOperations.{}',
        client_factory=cf_gallery_image)
    with self.command_group('sig', vm_gallery_image, client_factory=cf_gallery_image) as g:
        g.custom_command('update', 'sig_update', supports_no_wait=True)
        g.custom_command('group-list', 'sig_group_list')
        g.custom_command('share', 'sig_share', supports_no_wait=True)
        g.custom_wait_command('wait', 'sshkey_show')
    ...
    with self.command_group('sig image-definition', vm_shared_gallery_image,
        ...
        g.custom_command('list', 'sig_image_definition_list')
        g.custom_show_command('show', 'sig_image_definition_show')
    ...
    with self.command_group('sig image-version', vm_shared_gallery_image_version,
        ...
        g.custom_command('list', 'sig_image_version_list')
        g.custom_show_command('show', 'sig_image_version_show')
